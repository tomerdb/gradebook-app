    ...
    $scope.createUser = function() {
        ...
        ApiService.createUser($scope.newUser)
            .then(function(response) {
                loadUsers();
                $scope.newUser = { name: '', email: '', password: '', role: 'student' };
                $scope.showAddForm = false;
    ...
    $scope.createCourse = function() {
        ...
        ApiService.createCourse($scope.newCourse)
            .then(function(response) {
                ...
                $scope.newCourse = { name: '', description: '', teacher_id: '' };
...
.controller('AdminReportsController', function($scope, ApiService) {
    $scope.evaluations = [];
    ...
    $scope.downloadPDFReport = function() {
        var url = ApiService.downloadPDFReport({ type: 'all' });
        window.open(url, '_blank');
    };

    $scope.downloadCSVReport = function() {
        var url = ApiService.downloadCSVReport({ type: 'all' });
        window.open(url, '_blank');
    };
